"""Notify FileMaker that an import run has finished."""
...
URL = (
    ...
    "layouts/Api_Handshake/script/Finish_Import_API"
)


def mark_import_finished(status: str = "In progress"):
    ...
    headers = {"Authorization": f"Bearer {FILEMAKER_BEARER_TOKEN}"}
